...
const supportShell=$('#supportShell');
const supportInner=$('#supportInner');
const keychainRing=$('#keychainRing');
const keychainLink=$('#keychainLink');
...
function updateSupportShape(){
  ...
  keychainRing.style.display='none';
  keychainLink.style.display='none';
  supportShell.style.display='';

  if(type==='keychain-vertical'){
    product.classList.add('keychain-product','keychain-vertical');
    keychainRing.style.display='';
    keychainLink.style.display='';
    supportShell.className='keychain-shell';
    supportInner.className='keychain-inner';
    supportCanvas.width=800;
    supportCanvas.height=1200;
    product.style.aspectRatio='2 / 3';

  }else if(type==='keychain-horizontal'){
    product.classList.add('keychain-product','keychain-horizontal');
    keychainRing.style.display='';
    keychainLink.style.display='';
    supportShell.className='keychain-shell';
    supportInner.className='keychain-inner';
    ...
    product.style.aspectRatio='3 / 2';

  }else{
    product.classList.add('medal-product');
    supportShell.style.display='contents';
    supportInner.className='medal-inner';
