...
function drawPreservedReliefToCanvas(norm,target){
  ...
  // If the image was already prepared by Outpaint, use the CLEAN background
  // (subject removed) + subject once. Never draw sourceImg underneath the subject.
  if(aiPrepared){
    ...
    const baseScale=Math.min(W/bgW,H/bgH);
