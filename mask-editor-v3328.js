/* LentiPrint Lab V3.3.28 — éditeur de masque optimisé iPad
   Objectif: pinceau plus fluide, curseur immédiat, loupe allégée.
*/
(() => {
  'use strict';
  ...
  if (typeof originalLocalRemoveBackground !== 'function') {
    console.error('[MASK3328] localRemoveBackground introuvable');
    return;
  }
  ...
  console.log('[MASK3328] éditeur fluide actif');
})();
